...
public class VentanaLibro extends JFrame {
    ...
    public JButton getBtnleerBD() {
        return btnleerBD;
    }

    public void setBtnleerBD(JButton btnleerBD) {
        this.btnleerBD = btnleerBD;
    }
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(139, 224, 110));
        lblId = new JLabel("Id:");
        ...
        panel2.setBackground(new Color(156, 110, 224));
        btnleerBD = new JButton("Leer BD");
        panel2.add(btnleerBD);
        tblLibro = new JTable();
        ...
        panel3.setBackground(new Color(234, 222, 138));

        // ------ Panel 4 ------
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(224, 110, 110));
